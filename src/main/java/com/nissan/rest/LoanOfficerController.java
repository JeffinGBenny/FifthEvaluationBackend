...
public class LoanOfficerController {
	...
	public List<Loan> getLoanRequests()
			...
			{
		//jwtUtil.verify(auth);
		return loanOfficerService.getLoanRequests();
	}
	...
	public Loan getLoanRequest(@PathVariable int id)
			...
			{
		//jwtUtil.verify(auth);
		return loanOfficerService.getLoanRequest(id);
	}
	...
	{
		//jwtUtil.verify(auth);
		if(loanOfficerService.saveLoanRequest(loan)==null) {
...
*/
	...
	public void deleteLoanRequest(@PathVariable int id)
			...
			{
		//jwtUtil.verify(auth);
		loanOfficerService.deleteLoanRequest(id);
	}
